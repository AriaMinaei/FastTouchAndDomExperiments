...
spec ['visuals/lightmatrix/rotation', 'visuals/lightmatrix/scale', 'visuals/lightmatrix/base'], (Rotation, Scale, Base) ->
	...
	test 'xyz', ->
		...
		(Base.toArray(Rotation.matrix 1, 2, 3).map (v) -> v.toPrecision 4)

			.shouldEqual (Base.css2Array("matrix3d(0.41198224565683, -0.6812427202564033, 0.6051272472413688, 0, 0.05872664492762098, -0.642872836134547, -0.7637183366502791, 0, 0.9092974268256817, 0.35017548837401463, -0.2248450953661529, 0, 0, 0, 0, 1)").map (v) -> v.toPrecision 4)
